...
/* ASCII Art Diagrams — left-aligned, same as code blocks */
.ascii-diagram{margin:14px 0;overflow-x:auto}
.ascii-diagram pre{
  background:var(--code-bg)!important;border:1px solid var(--border);border-radius:8px;
  padding:14px 18px;font-family:'SF Mono','Fira Code','Cascadia Code',Consolas,monospace;
...
<nav class="sidebar">
  <a href="quick-guide.html" style="background:rgba(9,105,218,.08);font-weight:600;color:var(--accent);margin:0 8px 10px;border-radius:6px;border-left:none;text-align:center;padding:8px 16px"><span class="cn">Quick Guide</span><span class="en">Quick Guide</span></a>
